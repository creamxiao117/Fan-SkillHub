...
本技能由记忆中枢权威卡 [ideation-github-scan.md](.hub/methodology/ideation-github-scan.md) 升级生成, 内化其中
...
- 原卡标题命中: 立项研究
- 原卡 tags: context-engineering, research, blueprint, ideation, 立项研究：轻量, GitHub, 扫描产出「借鉴, 避开」最小指引
...
- **源**: .hub/methodology/ideation-github-scan.md
- **证据等级**: T0 静态验证
- **复用次数**: 3
...
- 源卡: .hub/methodology/ideation-github-scan.md
