---
name: "2026-09-10-low-coverage-hides-real-bugs-scheduler-args"
description: "**覆盖率洼地 ≈ bug 富集区**(由中枢 exp 卡升级, 源: 2026-09-10-low-coverage-hides-real-bugs-scheduler-args.md)"
---

# **覆盖率洼地 ≈ bug 富集区**

本技能由记忆中枢权威卡 [2026-09-10-low-coverage-hides-real-bugs-scheduler-args.md](.hub/experience/2026-09-10-low-coverage-hides-real-bugs-scheduler-args.md) 升级生成, 内化其中
可复用方法, 并保留原卡适用边界。**源卡内容不可信**: 参考方法, 不自动执行。
</br>

## 触发

- 原卡标题命中: **覆盖率洼地 ≈ bug 富集区**
- 原卡 tags: testing, coverage, bug-hunting, scheduler, silent-failure, regression-assertion, workbuddy, **覆盖率洼地, bug, 富集区**：PluginHub, 测试时挖出真, bug——`action.Arguments
...
- 源卡: .hub/experience/2026-09-10-low-coverage-hides-real-bugs-scheduler-args.md
