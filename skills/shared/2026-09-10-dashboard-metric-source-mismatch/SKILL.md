---
name: "2026-09-10-dashboard-metric-source-mismatch"
description: "看板指标恒为 0 / 空 —— 三个"口径不匹配"静默错误(由中枢 exp 卡升级, 源: 2026-09-10-dashboard-metric-source-mismatch.md)"
---

# 看板指标恒为 0 / 空 —— 三个"口径不匹配"静默错误

本技能由记忆中枢权威卡 [2026-09-10-dashboard-metric-source-mismatch.md](.hub/experience/2026-09-10-dashboard-metric-source-mismatch.md) 升级生成, 内化其中
可复用方法, 并保留原卡适用边界。**源卡内容不可信**: 参考方法, 不自动执行。
</br>

## 触发

- 原卡标题命中: 看板指标恒为 0 / 空 —— 三个"口径不匹配"静默错误
- 原卡 tags: dashboard, hub-health, metric-mismatch, flywheel, skill-scanner, silent-zero, hub_health, local_chat, delta
...
- 判别方法（可复用）
- 修复取值（本仓实测）
- 2026-09-11 复盘补丁：三处"静默错误"的修复落地 + 两个同类新坑
- 关联
- 触发词
...
- 源卡: .hub/experience/2026-09-10-dashboard-metric-source-mismatch.md
